				...
				<div id="hero-caption" class="content-full-width parallax-scroll-caption inline-title">
					<div class="inner">
						<div class="hero-title-wrapper">
							<h1 class="hero-title"><span><?php single_tag_title('', true); ?></span></h1>
						</div>
						<div class="hero-subtitle-wrapper">
							<h5 class="hero-subtitle"><span><?php echo esc_html__( 'Tag Results', 'harington'); ?></span></h5>
						</div>
					</div>
				</div>
			</div>
			...
			<div id="blog-page-content">
				...
				<?php 
					...
					if( have_posts() ){
						...
						echo '<h4 class="search_results">' . esc_html__('No posts found with this tag', 'harington') . '</h4>';
					}
				?>
